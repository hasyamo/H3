...
/*
import variable from "native-base/theme/variables/platform.js";
*/
    ...
    return (
      <View>
        <View>
          ...
          >
            {this.state.chosenDate ? moment(this.state.chosenDate).format(this.props.format) : this.props.placeHolderText ? this.props.placeHolderText : "Select Date"}
          </Text>
          <View>
            <Modal
